...
component extends="cborm.models.VirtualEntityService" singleton{
	...
	*/
	numeric function getMaxOrder(){
		var q = executeQuery( query="select max( sr.order ) from cbadmin_securityRule as sr", asQuery=false );
	...
	*/
	array function getSecurityRules(){
	...
	*/
	any function resetRules(){
		transaction{
			...
			//var q = new query(sql="delete from cbadmin_securityRule" ).execute();
