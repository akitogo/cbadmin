...
component accessors="true" threadSafe singleton {
	...
	boolean function isForceTwoFactorAuth(){
		...
		return !!settingService.getSetting( "cbadmin_security_2factorAuth_force" );
	}
	...
	string function getDefaultProvider(){
		return settingService.getSetting( "cbadmin_security_2factorAuth_provider" );
	}

	/**
	 * Get the default system provider object
	 */
	cbadmin.models.security.twofactor.ITwoFactorProvider function getDefaultProviderObject(){
	...
	numeric function getTrustedDeviceTimespan(){
		return settingService.getSetting( "cbadmin_security_2factorAuth_trusted_days" );
	}
	...
	TwoFactorService function registerProvider(
		required cbadmin.models.security.twofactor.ITwoFactorProvider provider
	){
	 ...
	 */
	cbadmin.models.security.twofactor.ITwoFactorProvider function getProvider( required name ){
